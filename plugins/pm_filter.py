...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Sᴜᴘᴘᴏʀᴛ Stark Oᴡɴᴇʀ ♥️')
            else:
        ...
        return await query.answer('♥️ Sᴜᴘᴘᴏʀᴛ Stark Owner ♥️')
    ...
    if query.data.startswith("file"):
        ...
        await query.answer('Sᴜᴘᴘᴏʀᴛ Stark Oᴡɴᴇʀ')
        ...
        buttons = [[
            InlineKeyboardButton('🙄 ᴏᴡɴᴇʀ 🙄', url='https://t.me/starkownerbot'),
